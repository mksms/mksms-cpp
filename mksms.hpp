...
class Message
{
    public:
        ...
        */
        ...
        {
            json json_cont = json_msg["contact"];
            this->contact = new Contact(json_cont);
            this->body = json_msg["body"];
            this->read = json_msg["read"];
            this->direction = json_msg["direction"];
        }
        /** @brief (one liner)
        *
        * (documentation goes here)
        */
        Message(Contact* contact, string body, Direction direction, bool read)
        {
    ...
    public:
        ...
        */
        ...
        /** @brief (one liner)
          ...
          * (documentation goes here)
        */
        Response(bool success, string message, json data)
        {
    ...
    public:
        ...
        */
        vector<Message> getMessages(time_t min_date, Direction direction, bool read, time_t timestamp)
        {
            ...
            httplib::Params params;
            params.emplace("direction", direction);
            params.emplace("read", read);
            params.emplace("timestamps", timestamp);
            params.emplace("api_key", this->api_key);
            params.emplace("api_hash", this->api_hash);
            auto res = client.Post(endpoint.c_str(), params);
        }
